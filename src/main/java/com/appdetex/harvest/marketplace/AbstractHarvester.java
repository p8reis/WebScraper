...
public abstract class AbstractHarvester implements MarketplaceHarvester {
    ...
    protected final List<MarketplaceDetection> parseTargetInternal(Document doc, int numItems) throws HarvestException {
    ...
    protected abstract MarketplaceDetection createDetection(Element src, int idx);
